...
class ConnectFour:
    ...
    # def heuristic(self):
    #     '''
    #     Estimate the value of a game position
    #     '''
    #     if self.winning(is_player=True): #on test si un des joueurs gagne et on y met un poid conséquent si c'est le cas
    #         return 100 * (42 - self.total_number_pawns())
    #     elif self.winning(is_player=False):
    #         return -100 * (42 - self.total_number_pawns())
